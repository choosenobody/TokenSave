...
**Last updated**: 2026-05-08T08:58:00Z
**Source**: GitHub `origin/main` at commit `d9ed115d4a64c9797af1c20aba8293c064d4f10e` (PR #117 feat(I15-B): active vs historical/disabled waste distinction; merge commit `d9ed115d4a64c9797af1c20aba8293c064d4f10e`)
...
| Main branch SHA | `d9ed115d4a64c9797af1c20aba8293c064d4f10e` (PR #117 feat(I15-B): active vs historical/disabled waste distinction; merge commit `d9ed115d4a64c9797af1c20aba8293c064d4f10e`) |
| Package manager | npm |
...
| tests/i15a-openclaw-cli-guidance.test.ts | 55 tests, covers CLI syntax correctness (openclaw cron/* vs openclaw jobs/*), forbidden patterns (--resume/--no-agent-turn/--dry-run/cron expression strings), multi-ID command risk, local path references, ERROR_WASTE --id flag syntax, --enable flag, cron disable vs edit --disable; total test suite 316 tests |
...
- I15-B (Active vs Historical/Disabled Waste Distinction) — **CLOSED (PR #117).** Implemented lifecycleStatus classification, activeJobs/historicalJobs split, muted historical review signals section, inspect-only historical fix cards.
...
- `npm test` passes 354 tests (PR #117: 38 tests in tests/i15b-active-historical.test.ts; total suite 10 files, 354 tests).
